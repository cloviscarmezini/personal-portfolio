        ...
        <div className="flex justify-center">
          <div className="rounded-full hover:shadow-card bg-gradient-to-b from-blue-500 to-purple-500">
            <div className="bg-tertiary m-[1px] text-sm text-white leading-none rounded-full inline-flex">
              <button onClick={() => setWorkType('personal')} className={`inline-flex items-center transition-colors duration-300 ease-in focus:outline-none hover:bg-blue-500 rounded-l-full px-4 py-2 ${workType === 'personal' ? 'bg-gradient-to-b from-blue-500 to-purple-500' : ''}`} id="grid">
              ...
              <button onClick={() => setWorkType('collaborate')} className={`inline-flex items-center transition-colors duration-300 ease-in focus:outline-none hover:bg-blue-500 rounded-r-full px-4 py-2 ${workType === 'collaborate' ? 'bg-gradient-to-b from-blue-500 to-purple-500' : ''}`} id="list">
